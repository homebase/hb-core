...
class ArrX
{
     ...
     */
    public static function callbackRE(array $field2re): \Closure
    {
     ...
     * @param string[] $field2re
     */
    public static function callbackNotRE(array $field2re): \Closure
    {
        return static fn (array $r) => Arr::all($field2re, static fn ($f, $re) => !preg_match($re, $r[$f]));
    }
     ...
     */
    public static function callbackIsIn(array $field2vals): \Closure
    {
     ...
     * @param mixed[] $field2vals
     */
    public static function callbackIsNotIn(array $field2vals): \Closure
    {
        $f2v1 = Arr::map($field2vals, static fn ($a) => Arr::flip1($a)); // [field => [value => 1]
     ...
     */
    public static function callbackIsBetween(array $field2ft): \Closure
    {
     ...
     * @param array{int, int}[] $field2ft
     */
    public static function callbackIsNotBetween(array $field2ft): \Closure
    {
        return static fn (array $r) => Arr::all($field2ft, static fn ($f, $ft) => !\hb2\between($r[$f], reset($ft), end($ft)));
    }
}
